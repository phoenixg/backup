<?php
$page_title = '统计万方视频数据库，求各来源和各学科的总时长、总大小';
include ('./includes/header.html');
?>
<style type="text/css">@import url(./css/wf_count_styles.css);</style>
<?php
$arraySource = array(
'0'=>'CCTV-7系列',
'1'=>'中国科学院系列',
...
echo "<br /><p><a href='wf_count_xls.php'>导出结果为Excel（问是否打开就点“是”）</a></p>";
