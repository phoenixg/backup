...
<?php
echo '<form action="wf_search_tbvideofilemanage.php" method="post">';
...
<script type='text/javascript'>
	...
	s1.addParam('flashvars','file=video.flv&plugins=http://www.nshen.net/blog/jw/pauseTxt_plugin&amp;n_pausetxt=sss')
	s1.write('testabcde');
</script>
